    ...
    <>
      ...
      <div className="bg-whit flex w-full space-x-4">
        <div className="flex w-full flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0">
          <div className="flex h-48 w-full flex-col items-center justify-center rounded-xl bg-stone-800 bg-opacity-30 outline outline-2 outline-stone-700 backdrop-blur-md">
